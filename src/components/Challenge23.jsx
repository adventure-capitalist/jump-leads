...
class Challenge23 extends Component {
    ...
    render() { 
        ...
        <div className="mainHolder">
            <div className="lessonHeader">
                <h2 className="lessonTitle">Lesson 23: Operators</h2>
                <div class="icons">
                    <GoBook onClick={() => this.props.callback(<Lesson23 callback={this.props.callback}/>)} className="dashIcon"/>
